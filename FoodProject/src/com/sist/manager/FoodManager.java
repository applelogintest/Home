...
public class FoodManager {
	...
	public ArrayList<FoodHouseVO> foodAllData() {
		...
		try {
			...
			for (CategoryVO cvo : cList) {
				/*
				 * <div class="with-review"> <figure class="restaurant-item"> <a
				 * href="/restaurants/jyBALjr9F5L0"
				 */
				...
				for (int j = 0; j < link.size(); j++) {
					try {
						...
						System.out.println("****************************************");
						/*
						 * <div class="restaurant_title_wrap"> <span
						 * class="title"> <h1 class="restaurant_name">토미야</h1>
						 * <strong class="rate-point "> <span>4.7</span>
						 * </strong>
						 */

						Element title = doc2.selectFirst("span.title h1.restaurant_name");
						
						Element score = doc2.selectFirst("span.title strong.rate-point");
						...
						vo.setImage(img);
						//[{"action_value":1,"count":6},{"action_value":2,"count":20},{"action_value":3,"count":100}]
	...
	public static void main(String[] args) {
		...
		ArrayList<FoodHouseVO> list=fd.foodAllData();
		...
		/*
		 * FoodDAO dao=FoodDAO.newInstance(); ArrayList<CategoryVO> list=new
		 * ArrayList<CategoryVO>(); list=fd.categoryAllData();
		 * 
		 * //ArrayList<CategoryVO> list=fd.categoryAllData();
		 * //ArrayList<CategoryVO> list=new ArrayList<CategoryVO>();
		 * 
		 * int k=1; for(CategoryVO vo:list) { dao.catagoryInsert(vo);
		 * System.out.println("k="+k); k++; } System.out.println("Save End...");
		 */
