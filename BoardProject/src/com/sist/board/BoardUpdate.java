...
public class BoardUpdate extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<input type=text name=name size=15 required value="+vo.getName()+">"); // required는 5.0버전에서만 사용가능
		...
		out.println("<td width=85%>");
		out.println("<input type=text name=subject size=50 required value=\""+vo.getSubject()+"\">"); //공백으로 끊어 읽기때문에 따옴표를 넣어줘야된다
		out.println("</td>");
		out.println("</tr>");
