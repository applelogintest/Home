...
<%
   //https://www.google.com/search?q=%EC%9E%90%EB%B0%94&oq=%EC%9E%90%EB%B0%94&aqs=chrome..69i57j35i39l2j0l5.2164j0j8&sourceid=chrome&ie=UTF-8
	try{
		request.setCharacterEncoding("UTF-8");	// 안써주면 한글깨짐
	}catch(Exception ex){}
...
<body>
	<center>
		...
		<table id="table_content">
			<tr>
				<td width="20%" class="tdright">입력</td>
				<td>
