...
public class Login extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("</head>");
		out.println("<body>");
		out.println("<div class=container>"); // container, container-fluid(전체 화면)
		 ...
		 *  xs 	
		 	...
		 	lg
		 */
		out.println("<td colspan=2 class=text-center><input type=submit class=\"btn btn-sm btn-info\" value=로그인></td>");
		out.println("</tr>");
		out.println("</table>");
		out.println("</form>");
		out.println("</div>"); // .row
